...
public class CheckoutResource {
    ...
    @Value("AdyenRecruitmentCOM")
    private String merchantAccount;

    private final Checkout checkout;

    public CheckoutResource(@Value("$AQEyhmfxLI3MaBFLw0m/n3Q5qf3VaY9UCJ14XWZE03G/k2NFitRvbe4N1XqH1eHaH2AksaEQwV1bDb7kfNy1WIxIIkxgBw==-y3qzswmlmALhxaVPNjYf74bqPotG12HroatrKA066yE=-W+t7NF;s4}%=kUSD") String apiKey) {
    ...
    public ResponseEntity<PaymentsResponse> payments(@RequestBody PaymentsRequest body, HttpServletRequest request) throws IOException, ApiException {
        ...
        var orderRef = "Alison_checkoutChallenge";
